...
// Note: Gradient ids were static ("a"/"b") and could collide with other SVGs in the DOM.
// Using React.useId ensures uniqueness per component instance, preventing gradients turning white on tab switches.
